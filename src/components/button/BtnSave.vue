...
<template>
  <button class="btn-scale flex items-center outline-none text-xs text-gray-mid hover:text-gray-dark focus:outline-none focus:shadow-outline" ref="btnSave" title="Save Task List to LocalStorage" @click="onSave" :disabled="!btnState.enabled">
